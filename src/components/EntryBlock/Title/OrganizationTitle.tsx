...
export function OrganizationTitle({
  ...
  if (isEditing) {
    return (
      <div className="flex flex-col gap-2 w-full">
        ...
        <div  onClick={onOrgModalOpen} title="Change organization"  className="flex items-center gap-2 mt-1">
          <div
  ...
  return (
    <>
      ...
      >
        <img
          className="w-10 h-10 rounded bg-neutral-400/10 lg:grayscale lg:group-hover:grayscale-0" // Оставляем grayscale для режима просмотра
          src={organization.logo}
          alt={`${organization.title} logo`}
          onError={(e) => {
            e.currentTarget.src = "/images/placeholder-logo.png";
      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <span className="inline-block border-b border-transparent group-hover:border-blue-600 dark:group-hover:border-blue-300 lg:border-0"> {/* Убрал начальную границу, добавил hover */}
            {organization.title}
